      ...
      {activeCandidatesList.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Uploaded Resumes ({activeCandidatesList.length})</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-2.5 pt-2 border-t border-gray-50 flex items-center justify-between text-[10px] text-gray-400">
                      ...
                      <span>Target: {targetJD?.company || 'Unassigned'}</span>
                    </div>
                  </div>
                );
              })}
