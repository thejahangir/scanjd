...
const AddAnotherJDModal = ({ isOpen, onClose }) => {
  ...
  return (
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50 flex-shrink-0">
              <div>
                <h3 className="text-xl font-bold text-gray-900">Add Another Job Description</h3>
    ...
    <ConfirmModal
      ...
      message="Are you sure you want to save this new Job Description? It will be added to the active flow."
      confirmText="Yes, Save JD"
      theme="blue"
    />
    </>
  );
...
export default AddAnotherJDModal;
