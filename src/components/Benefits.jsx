  ...
  return (
    <section id="benefits" className="py-24 bg-brand-blue relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-purple-500/20 blur-[100px]" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-blue-200 font-semibold tracking-wide uppercase text-sm mb-3">Business Impact</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Transform Your Recruitment Process
            </h3>
            <p className="text-lg text-blue-100 mb-8 max-w-xl mx-auto md:mx-0 leading-relaxed">
