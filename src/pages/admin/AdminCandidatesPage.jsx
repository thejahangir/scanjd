...
const AdminCandidatesPage = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      default: return <span className="px-2.5 py-1 bg-brand-blue/10 text-brand-blue border border-brand-blue/20 rounded-lg text-xs font-bold">Screening</span>;
    }
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-bold text-brand-blue uppercase tracking-wider">Candidate Pool</span>
          </div>
        ...
        <div className="relative self-start sm:self-auto">
          <button
            ...
            className="flex items-center gap-3 px-4 py-2.5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-brand-blue/40 hover:bg-brand-blue/5 transition-all text-left min-w-[260px]"
          >
              ...
              <div className="absolute top-full right-0 mt-2 z-20 w-80 bg-white border border-gray-200 rounded-2xl shadow-xl py-2 max-h-80 overflow-y-auto flex flex-col">
                ...
                <div className="px-3 py-2 border-b border-gray-100 relative bg-gray-50/50 sticky top-0 z-10">
                  ...
                  <input
                    ...
                    className="w-full pl-7 pr-3 py-1.5 bg-white border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-brand-blue transition-all"
                  />
                </div>
                  ...
                  {filteredSwitcherJDs.length === 0 ? (
                    ...
                    filteredSwitcherJDs.map(jd => (
                      <button
                        ...
                        className={`w-full flex items-start gap-3 px-3 py-2.5 text-left transition-colors hover:bg-gray-50 ${selectedJdId === jd.id ? 'bg-brand-blue/5' : ''}`}
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className={`text-xs font-bold truncate ${selectedJdId === jd.id ? 'text-brand-blue' : 'text-gray-800'}`}>{jd.title}</div>
            ...
            <div className="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row gap-3 items-center justify-between">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-brand-blue hover:bg-brand-blue/90 text-white rounded-xl text-xs font-bold transition-all shadow-sm shadow-brand-blue/15 cursor-pointer"
                >
                      ...
                      <td colSpan={6} className="text-center py-16 text-gray-400">
                        <div className="flex flex-col items-center justify-center gap-3 py-6">
                          ...
                          <button
                            type="button"
                            onClick={openAssignModal}
                            className="mt-1 px-4 py-2 bg-brand-blue hover:bg-brand-blue/95 text-white font-bold rounded-xl text-xs flex items-center gap-1.5 shadow-sm shadow-brand-blue/10 cursor-pointer"
                          >
                    ...
                    paginatedCandidates.map((c) => {
                      ...
                      return (
                        <tr
                          ...
                          className={`hover:bg-brand-blue/5 cursor-pointer transition-colors ${isSelected ? 'bg-brand-blue/10' : ''}`}
                        >
                          <td className="p-4 pl-6 font-semibold text-gray-900">
                            <div className="flex items-center gap-2.5">
                              <div className="w-8 h-8 rounded-lg bg-brand-blue/10 font-bold text-brand-blue flex items-center justify-center flex-shrink-0">{c.initials}</div>
                              <div>
            ...
            >
                ...
                {selectedCandidate.interviewQuestions?.length > 0 && (
                  <div className="pt-2 border-t border-gray-100 space-y-2">
                    <span className="font-bold text-gray-700 block flex items-center gap-1 text-[11px]">
                      <HelpCircle className="w-3.5 h-3.5 text-brand-blue" /> Suggested Screening Topics
                    </span>
              ...
              <div className="pt-4 border-t border-gray-100 grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="py-2 px-3 bg-brand-blue hover:bg-brand-blue/90 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1"
                >
            ...
            >
              ...
              <div className="px-5 py-3.5 bg-gray-50/50 border-b border-gray-100 relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-brand-blue transition-all"
                />
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          {/* Avatar */}
                          <div className="w-8 h-8 rounded-lg bg-brand-blue/10 font-bold text-[11px] text-brand-blue flex items-center justify-center flex-shrink-0">
                            {c.initials}
                          </div>
              ...
              <div className="p-4 border-t border-gray-100 bg-gray-50/50 flex items-center justify-end gap-2.5">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-brand-blue hover:bg-brand-blue/90 text-white rounded-xl text-xs font-bold shadow-sm shadow-brand-blue/15 transition-all cursor-pointer"
                >
                  Save Changes
                </button>
              </div>
