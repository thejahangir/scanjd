  ...
  const initialAdminNotifications = [
    {
      ...
      desc: 'Batch ingest for TCS APAC Mandate complete. 120 resumes ingested.',
      time: '12 mins ago',
      read: false,
      icon: Sparkles,
    ...
    },
    {
      ...
      desc: 'Vikram Mehta assigned to open Infosys Cloud Infrastructure systems role.',
      time: '2 hours ago',
      read: true,
      icon: User,
    ...
    },
    {
      ...
      desc: 'Wipro AI gateway integration key rotated successfully.',
      time: '1 day ago',
      read: true,
      icon: Settings,
